...
// CAssignment3aDlg 메시지 처리기

BOOL CAssignment3aDlg::OnInitDialog()
{
...
void CAssignment3aDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CAssignment3aDlg::OnQueryDragIcon()
{
